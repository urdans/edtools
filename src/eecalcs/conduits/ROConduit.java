...
public interface ROConduit {
	...
	/**
	 ...
	 Table
	 1 and notes to tables in Chapter 9.
	...
	/**
	 @return The ratio between the total conduitable areas and the conduit area
	 as a percentage. This is how much a conduit is filled. It may return 0 if
	 the trade size is null.
	 */
