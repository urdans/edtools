...
class CircuitTest {
    ...
    private void printState(){
        ...
        Tools.println("Max voltage drop: " + circuit.getVoltageDrop().params.maxVoltageDropPercent);
        Tools.println("Size per voltage drop: " + s);
        NumberFormat nf = NumberFormat.getPercentInstance();
        nf.setMinimumFractionDigits(2);
        String vdp =
                nf.format(0.01*circuit.getVoltageDrop().resultsSize.vdPercentForMinSize);
...
*/
    ...
    void getCircuitSize_VDrop_Neutral_OCPD_Grounding_ConductorsUpdated_TradeSize() {
        ...
        assertEquals(1.333, circuit.getVoltageDrop().resultsVD.voltageDropVolts,0.001);
        assertEquals(0.277, circuit.getVoltageDrop().resultsVD.voltageDropPercentage,0.001);
        assertEquals(478.666, circuit.getVoltageDrop().resultsVD.voltageAtLoad,0.001);
        assertEquals(1084.734, circuit.getVoltageDrop().resultsVD.maxLengthForMaxVD,0.001);
