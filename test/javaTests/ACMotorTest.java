...
/*		//no 3φ 90v motors on NEC-430.250 (wrong voltage system voltage value)
		...
		assertDoesNotThrow(()->
				new ACMotor(MotorProperties.Type.AC2P, 230,
						Horsepower.HP_15, VoltageAC.v240_1ph_3w));

		assertDoesNotThrow(()->
				new ACMotor(MotorProperties.Type.AC2P, 115,
						Horsepower.HP_2, VoltageAC.v120_1ph_2w));

/*		assertDoesNotThrow(()->
				new ACMotor(MotorProperties.Type.AC3P, 115,
						Horsepower.HP_2,
						VoltageAC.v_other.setValues(115, 3,3)));
		...
		assertDoesNotThrow(()->
				new ACMotor(MotorProperties.Type.AC3P, 600,
						Horsepower.HP_2,
						VoltageAC.v_other.setValues(600, 3,3)));*/
	}

	@Test
	void getMotorVoltage() {
		assertEquals(115,new ACMotor(MotorProperties.Type.AC1P, 110,
				Horsepower.HP_1$6, VoltageAC.v120_1ph_2w).getMotorVoltage());
...
/*		assertEquals(200,new ACMotor(MotorProperties.Type.AC1P, 200,
				Horsepower.HP_1$6,
				VoltageAC.v_other.setValues(200,1, 2)).getMotorVoltage());*/

		assertEquals(208,new ACMotor(MotorProperties.Type.AC1P, 208,
				Horsepower.HP_1$6, VoltageAC.v208_1ph_2w).getMotorVoltage());

		assertEquals(230,new ACMotor(MotorProperties.Type.AC1P, 220,
				Horsepower.HP_1$6, VoltageAC.v240_1ph_2w).getMotorVoltage());
...
/*		assertEquals(Horsepower.HP_1,new ACMotor(MotorProperties.Type.AC1P, 200,
	...
	void getMaxOCPDRating() {
		...
		acMotor = new ACMotor(MotorProperties.Type.AC1P,115,
				Horsepower.HP_3$4, VoltageAC.v120_1ph_2w);
		...
		acMotor = new ACMotor(MotorProperties.Type.AC2P,230,
				Horsepower.HP_1, VoltageAC.v240_1ph_2w);
		...
		acMotor = new ACMotor(MotorProperties.Type.AC2P,480,
				Horsepower.HP_200, VoltageAC.v480_1ph_2w);
		...
		acMotor = new ACMotor(MotorProperties.Type.AC3P,480,
				Horsepower.HP_40, VoltageAC.v480_3ph_4w);
		...
		acMotor = new ACMotor(MotorProperties.Type.AC3PS,600,
				Horsepower.HP_25, VoltageAC.v600_3ph_3w);
	...
	void getMinDSRating() {
		acMotor = new ACMotor(MotorProperties.Type.AC1P,115,
				Horsepower.HP_1_1$2, VoltageAC.v120_1ph_2w);
		assertEquals(30, acMotor.getMinDSRating());
		assertEquals(20*120, acMotor.getApparentPower());
		assertEquals(20*120*0.8, acMotor.getRealPower());

		acMotor = new ACMotor(MotorProperties.Type.AC3P,440,
				Horsepower.HP_500, VoltageAC.v480_3ph_3w);
		assertEquals(800, acMotor.getMinDSRating());
		assertEquals(590*480*Math.sqrt(3), acMotor.getApparentPower());
		assertEquals(590*480*Math.sqrt(3)*0.8, acMotor.getRealPower());
	}
